                    ...
                    <div class="relative bg-white rounded-lg shadow     ">
                        ...
                        <div class="p-4 md:p-5 space-y-4">
                            ...
                            <form class="max-w-sm mx-auto">
                                {{-- steps --}}
                                <label for="countries" class="block mb-2 text-lg font-medium text-gray-900 ">Steps</label>
                                <select id="countries" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 ">
                                  <option selected>Choose a Steps</option>
                                  <option value="US">Steps 1</option>
                                  <option value="CA">Steps 2</option>
                                  <option value="FR">Steps 3</option>
                                  <option value="DE">Steps 4</option>
                                </select> 
                                {{-- notes --}}
                                <label for="message" class="block mb-2 text-lg font-medium text-gray-900 ">Your Notes</label>
                                <textarea id="message" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-red-500 focus:border-red-500 " placeholder="Leave a notes..."></textarea>
                                <div class="flex justify-center items-center">
                                    <button data-modal-hide="static-modal" type="button" class="text-white bg-red-600 hover:bg-red-800 mt-5 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center ">Submit</button>
                                </div>
