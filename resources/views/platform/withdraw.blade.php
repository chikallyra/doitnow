    ...
    <section class="bg-white h-screen">
        ...
        <section class="w-full bg-white fixed z-30">
            <div class=" flex-grow  justify-center lg:mx-24 mx-10 pt-5">
                ...
                <h1 class="  text-black text-2xl font-bold text-center mt-[-30px] pb-3">Whitdraw</h1>   
            </div>
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg max-w-xl w-full mx-5 ">
                ...
                <form id="withdraw-form" class="space-y-4">
                    ...
                    <div>
                      ...
                      <select id="payment-method" name="payment-method" class="mt-1 block w-full p-2 border border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500" required>
                    ...
                    <div class="mb-6">
                      ...
                      <input type="tel" id="tel" name="tel" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5" placeholder="Enter your phone number" required>
                    </div>
