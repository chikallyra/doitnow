    ...
    <div class="pt-24">
        <div class="container mx-auto">
            <div class="bg-white shadow-md rounded-lg p-6">
                ...
                <form action="{{ route('bcategories.update', $blogCategory) }}" method="POST">
                    @method('PUT')
                    @csrf
                    <!-- Kategori -->
                    <div class="mb-4">
                        <label for="category" class="block text-gray-700 text-sm font-bold mb-2">Kategori:</label>
                        <input type="text" id="category" name="name" value="{{ $blogCategory->name }}" placeholder="Masukkan kategori"
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="description" name="desc" rows="4" placeholder="Masukkan deskripsi"
                                  class="shadow appearance-none bg-white border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">{{ $blogCategory->desc }}</textarea>
                    </div>
