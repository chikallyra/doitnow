        ...
        <div class="max-w-md relative justify-center items-center mx-auto">
          <form class="max-w-sm mx-auto  "  action="{{ route('register.company') }}" method="POST">
            ...
            <div class="mb-5">
              ...
              <input type="text" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Enter your full name Company's" value="{{ old('name') }}" required />
              @error('name')
            ...
            <div class="mb-5">
              ...
              <input type="email" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Enter your full email Company's" value="{{ old('email') }}" required />
              @error('email')
                <div class="text-red-500">
                    {{ $message }}
                </div>
            ...
            <div class="mb-5">
              ...
              <input type="text" id="phone" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Enter your full phone phone Company's" value="{{ old('phone') }}" required />
              @error('phone')
                <div class="text-red-500">
                    {{ $message }}
                </div>
