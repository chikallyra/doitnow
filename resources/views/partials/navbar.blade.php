...
<nav class=" bg-bg fixed z-50 w-full py-4 shadow-lg transition-all duration-300 backdrop:blur-xl bg-[#F4F4F4]">
  ...
  <div id="menu" class=" bg-bg text-center lg:hidden">
    ...
    <a href="../src/donate.html" class="block  sm:text-xl text-black hover:text-gray-300 px-4 py-2">About Us</a>
    <a href="../src/contact.html" class="block  sm:text-xl text-black hover:text-gray-300 px-4 py-2">Contact Us</a>
    <a
