                ...
                .then(data => {
                    ...
                    if (data.length > 0) {
                        data.forEach(mission => {
                            ...
                            `;
                            searchResults.innerHTML += missionCard;
                        });
                        startCountdown();
                    } else {
                        searchResults.innerHTML = '<p class="text-center text-gray-500">No missions found.</p>';
                    }
                })
                .catch(error => {
                    console.error('There was a problem with the fetch operation:', error);
                    searchResults.innerHTML = '<p class="text-center text-gray-500">An error occurred: ' + error.message + '. Please try again later.</p>';
                });
        } else {
            searchResults.innerHTML = '';
        }
