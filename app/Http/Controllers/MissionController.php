...
class MissionController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validatedData = $request->validate([
            ...
            'exsiting_reward' => 'nullable|exists:rewards,id',
            'new_reward' => 'nullable|string|required_without:exsiting_reward',
        ...
        if ($request->filled('exsiting_reward')) {
            $reward = Reward::find($request->exsiting_reward);
        } else {
